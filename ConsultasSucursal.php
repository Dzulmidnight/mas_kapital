...
if(isset($_POST['accion'])){
	if($_POST['accion']==1){
		...
		?>
		<div class="col-md-12 h2"><?php echo $Estado; ?></div>
		<?php
		...
		?>
			<div class="col-sm-3 text-justify" name="Infos" id="Infos" style="height: 10em">
				...
				<p>
					<?php echo "Calle: ".$fila['Calle']." No. ".$fila['Numero']." Col. ".$fila['Colonia']. ", ".$fila['Municipio'].", ".$fila['Estado'].",  C.P. ".$fila['CP']; ?>
					<br>
					Tel: <?php echo  $fila['Telefono']; ?>
					<br>
					<?php echo $fila['Email']; ?>
				</p>
			</div>
