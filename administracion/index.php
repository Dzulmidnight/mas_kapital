...
<html lang="esp">
  <head>
    ...
    <title>Administración - MásKapital</title>
  ...
  <section id="container" >
      ...
      <header class="header white-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo">Más<span>Kapital</span></a>
            <!--logo end-->
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li><a href="../conexion/salir.php"><i class="fa fa-key"></i> Log Out</a></li>
                        </ul>
                    </li>
