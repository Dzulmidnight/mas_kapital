                          ...
                          <tbody>
                            ...
                            ?>
                              <tr class="gradeX">
                                ...
                                <td>
                                <form id="<?php echo 'frm_sucursal'.$registros['idSucursales']; ?>" action="" method="POST">
                                  <input type="text" name="idsucursal" id="idsucursal" value="<?php echo $registros['idSucursales']; ?>">
                                  <button id="<?php echo 'btn-editar'.$registros['idSucursales']; ?>" type="button" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#modalEditarSucursal"><i class="fa fa-pencil"></i></button>
                                  <button id="" class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></button>
                                </form>
                                <?php
                                echo "<script>";
                                  //var x = '#btn-editar'+n;
                                  echo "$(document).on('ready',function(){";
                                    ...
                                    echo "$('#btn-editar".$registros['idSucursales']."').click(function(){";
                                      echo "var url = 'datos.php';";                                   

                                      echo "$.ajax({";                        
                                         echo "type: 'POST',";                 
                                         echo "url: url,";                    
                                         echo "data: $('#frm_sucursal".$registros['idSucursales']."').serialize(),";
                                         echo "success: function(data)";           
                                         echo "{";
                                           echo "$('#resp_id').html(data);";          
                                         echo "}";
                                       echo "});";
                                    echo "});";
                                  echo "});";
            ...
            <div class="modal-content">
              ...
              <form action="" id="" method="POST" enctype="multipart/form-data">
                  <div class="modal-header">
                      ...
                      <h4 class="modal-title"><b>Editar Sucursal <span style="color:red" id=""></span></b></h4>
                  </div>
                  <div id="resp_id" class="modal-body">
                    <!-- page start-->
